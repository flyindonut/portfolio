...
<template>
  <div class="flex h-dvh overflow-y-scroll">
    ...
    >
      ...
      <p v-if="!errorMessage && technologies.length === 0" class="text-gray-400 mt-6">No technologies available.</p>
    ...
    <div class="bg-[#161a1d] p-6 rounded-xl shadow-2xl border border-gray-700 text-white w-full max-w-md mx-auto">
      ...
      <form @submit.prevent="handleCreateTechnology" class="space-y-4">
        ...
        <div>
          ...
          <input v-model="newTechnology.name" type="text" class="w-full bg-[#212529] text-white border border-gray-600 rounded-lg p-2 focus:ring focus:ring-gray-500" required />
        </div>
